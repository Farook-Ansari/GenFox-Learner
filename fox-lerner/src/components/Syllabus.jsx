...
const Syllabus = ({ category, categoryIcon, categoryColor, onBackClick }) => {
  ...
  const syllabus = {
    modules: [
      ...
      },
      {
        ...
        lessons: [
          { id: 301, title: "Array", completed: false },
  ...
  const completedLessons = syllabus.modules.reduce(
    (total, module) =>
        ...
        <div className="p-6">
          ...
          <div className="bg-white rounded-xl p-6 mb-8 border border-slate-100">
            ...
            <p className="text-slate-600 mb-4">
              This comprehensive course covers all the essential aspects of{" "}
              {category}. You'll learn fundamental concepts, practical
              applications, and advanced techniques through structured modules
                ...
                >
                  ...
                  >
                    <div className="flex justify-between items-center">
                      ...
                      >
                        ...
                        {isModuleCompleted && <span className="ml-2">✓</span>}
                      </div>
                    </div>
                  </div>
                  ...
                  <div
                    className={`overflow-hidden transition-all duration-300 ease-in-out ${
                      expandedModules[module.id] ? "max-h-96" : "max-h-0"
                    }`}
                  >
                    <div className="divide-y divide-slate-100">
                      {module.lessons.map((lesson) => (
                        <div
                          ...
                          onClick={() =>
                            handleLessonClick(module.title, lesson)
                          }
                        >
                          <div className="flex items-center">
                            <div
                  ...
                  >
                    ...
                    <div className="text-left">
                      ...
                      <div className="text-sm text-slate-500">
                        Access code repositories for this course
                      </div>
                    </div>
                  </button>
                </div>
